...
def octaveBandCoherence(degrAudioBands, refAudioBands,
    ...
    * fftfreqs : ndarray
    ...
    # Ensure psdWindow is not larger than the signal length
    signal_length = len(degrAudioBands[0])
    if psdWindow > signal_length:
        psdWindow = signal_length // 2  # Reduce psdWindow to half the signal length
