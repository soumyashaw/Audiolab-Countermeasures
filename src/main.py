...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', '--target_dir', type=str, help="path to the target audio's directory", default="/home/soumyas_kvmohan/ASVspoof_train/train_spoof/gaussian_noise/")
    parser.add_argument('-r', '--reference_dir', type=str, help="path to the reference audio's directory", default="/home/soumyas_kvmohan/ASVspoof_train/train_spoof/gaussian_noise/")
