    ...
    while True:
        ...
        if selected_option_index == 0:
            ...
            if utility_data_augmentation_selected_option_index == 1:
                ...
                add_voip_perterbation_effects(gaussian_SNR_levels, ambient_SNR_levels, args.ambient_noise_dir, args.lower_sampling_rate, args.current_sampling_rate, args.reference_dir, args.sti_threshold)
